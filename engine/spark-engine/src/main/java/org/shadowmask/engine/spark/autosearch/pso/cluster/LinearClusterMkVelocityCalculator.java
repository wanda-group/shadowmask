...
public class LinearClusterMkVelocityCalculator
    extends ClusterMkVelocityCalculator {
  @Override public double randomSearchRate() {
    return 0.05;
  }

  protected Double learnedNewValue(Double currentVelocity, Double currentValue,
  ...
  protected Double learnedNewValue(Integer currentVelocity,
