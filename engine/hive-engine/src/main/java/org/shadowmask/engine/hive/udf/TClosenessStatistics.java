...
public class TClosenessStatistics {
  public double maxTClosenessValue = 0;
  public double minTClosenessValue = 0;
  public double meanTClosenessValue = 0;

  public TClosenessStatistics () {
    maxTClosenessValue = 0;
    minTClosenessValue = 0;
    meanTClosenessValue = 0;
  }

  public TClosenessStatistics (double maxTClosenessValue, double minTClosenessValue, double meanTClosenessValue) {
